...
type ResolveResourceTypesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	SourceFormat SourceFormat `protobuf:"varint,1,opt,name=source_format,json=sourceFormat,proto3,enum=finfocus.v1.SourceFormat" json:"source_format,omitempty"`
	...
	SourceTypes   []string `protobuf:"bytes,2,rep,name=source_types,json=sourceTypes,proto3" json:"source_types,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResolveResourceTypesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ResolveResourceTypesRequest) GetSourceTypes() []string {
	if x != nil {
...
type ResolveResourceTypesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ResolveResourceTypesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type ResourceTypeMapping struct {
	...
	PulumiToken string `protobuf:"bytes,1,opt,name=pulumi_token,json=pulumiToken,proto3" json:"pulumi_token,omitempty"`
	...
	PropertyMappings map[string]string `protobuf:"bytes,3,rep,name=property_mappings,json=propertyMappings,proto3" json:"property_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ResourceTypeMapping) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ResourceTypeMapping) GetPulumiToken() string {
	if x != nil {
		return x.PulumiToken
	}
	return ""
}

func (x *ResourceTypeMapping) GetSupported() bool {
	if x != nil {
		return x.Supported
	}
	return false
...
func (x *ResourceTypeMapping) GetPropertyMappings() map[string]string {
	if x != nil {
...
const file_finfocus_v1_costsource_proto_rawDesc = "" +
	...
	"\x13ResourceTypeMapping\x12!\n" +
	"\fpulumi_token\x18\x01 \x01(\tR\vpulumiToken\x12\x1c\n" +
	"\tsupported\x18\x02 \x01(\bR\tsupported\x12c\n" +
	"\x11property_mappings\x18\x03 \x03(\v26.finfocus.v1.ResourceTypeMapping.PropertyMappingsEntryR\x10propertyMappings\x1aC\n" +
	"\x15PropertyMappingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x16DISMISSAL_REASON_OTHER\x10\a2\xfc\b\n" +
	...
	"\tBatchCost\x12\x1d.finfocus.v1.BatchCostRequest\x1a\x1e.finfocus.v1.BatchCostResponse\x12k\n" +
	"\x14ResolveResourceTypes\x12(.finfocus.v1.ResolveResourceTypesRequest\x1a).finfocus.v1.ResolveResourceTypesResponse2\xb3\x02\n" +
