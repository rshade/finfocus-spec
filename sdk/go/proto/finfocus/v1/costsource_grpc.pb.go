...
const (
	...
	CostSourceService_ResolveResourceTypes_FullMethodName  = "/finfocus.v1.CostSourceService/ResolveResourceTypes"
)
...
type CostSourceServiceClient interface {
	...
	ResolveResourceTypes(ctx context.Context, in *ResolveResourceTypesRequest, opts ...grpc.CallOption) (*ResolveResourceTypesResponse, error)
}
...
func (c *costSourceServiceClient) ResolveResourceTypes(ctx context.Context, in *ResolveResourceTypesRequest, opts ...grpc.CallOption) (*ResolveResourceTypesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResolveResourceTypesResponse)
	err := c.cc.Invoke(ctx, CostSourceService_ResolveResourceTypes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CostSourceServiceServer interface {
	...
	//   - InvalidArgument: Malformed request (should not normally occur)
	//   - Internal: Unexpected error during type resolution
	ResolveResourceTypes(context.Context, *ResolveResourceTypesRequest) (*ResolveResourceTypesResponse, error)
...
func (UnimplementedCostSourceServiceServer) ResolveResourceTypes(context.Context, *ResolveResourceTypesRequest) (*ResolveResourceTypesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveResourceTypes not implemented")
}
...
func _CostSourceService_ResolveResourceTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResolveResourceTypesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CostSourceServiceServer).ResolveResourceTypes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CostSourceService_ResolveResourceTypes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CostSourceServiceServer).ResolveResourceTypes(ctx, req.(*ResolveResourceTypesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CostSourceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResolveResourceTypes",
			Handler:    _CostSourceService_ResolveResourceTypes_Handler,
		},
	},
