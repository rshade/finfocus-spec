...
const (
	...
	SourceFormat_SOURCE_FORMAT_TERRAFORM SourceFormat = 1
	...
	SourceFormat_SOURCE_FORMAT_CLOUDFORMATION SourceFormat = 2
)
...
var (
	SourceFormat_name = map[int32]string{
		...
		1: "SOURCE_FORMAT_TERRAFORM",
		2: "SOURCE_FORMAT_CLOUDFORMATION",
	}
...
const file_finfocus_v1_enums_proto_rawDesc = "" +
	...
	"\x13USAGE_PROFILE_BURST\x10\x03*l\n" +
